    ...
    return (
        <div>
            ...
            <form onSubmit={e => getMeaning(e)} className="relative block my-7">
                <input type="search" name='dictionaryKeyword' id='test' className="w-full bg-slate-100 py-2 px-4 rounded-md focus:outline-none font-bold border border-gray-300" placeholder='Search word...' onChange={(e) => setKeyword(e.target.value)} />
